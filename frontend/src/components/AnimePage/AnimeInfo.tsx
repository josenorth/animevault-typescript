    ...
    >
      <div className="flex flex-col md:flex-row items-start">
        ...
        <div className="flex-grow">
          <h3 className="text-2xl font-semibold mb-2">{anime.title_english}</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">{anime.format} • {anime.episode_count} episodes • {anime.episode_duration} min</p>
          ...
          <p className="text-gray-700 dark:text-gray-200 mb-2">
            <span className="font-semibold">Aired:</span> {anime.start_date} to {anime.end_date}
          </p>
          <p className="text-gray-700 dark:text-gray-200 mb-2">
            <span className="font-semibold">Score:</span> {anime.average_score}%
          </p>
